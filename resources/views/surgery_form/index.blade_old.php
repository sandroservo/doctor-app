            ...
            <form method="POST" action="{{ route('surgeries.store') }}" class="space-y-6">
				...
				<div>
                                ...
                                <select id="ligation" name="ligation" class="block mt-1 w-full dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
                                    ...
                                    <option value="0" {{ old('ligation', (string) $surgery->ligation ?? '') === '0' ? 'selected' : '' }}>N�o</option>
                                </select>
                    ...
                    <form id="addSurgeryForm">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" id="new_surgery" name="new_surgery"
                                ...
                                required>
                            <label for="new_surgery_type"
                                class="block text-sm font-medium dark:text-gray-300">Tipo de Cirurgia</label>

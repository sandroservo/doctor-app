...
use App\Http\Controllers\Dashboads\CirurgiaoDashboardController;
use App\Http\Controllers\Dashboads\PdfDashboardController;
...
Route::get('/dashboard3', [CirurgiaoDashboardController::class, 'index'])->name('dashboard3');
Route::get('/dashboard3/detalhes/{id}', [CirurgiaoDashboardController::class, 'show'])->name('surgeries.show');
Route::get('/dashboard3/listar/{tipo}', [DashboardController::class, 'listarPorTipo']);
Route::get('/dashboard3/pdf', [PdfDashboardController::class, 'generatePdf'])->name('dashboard3.pdf');
Route::get('/dashboard3/detalhespdf', [DashboardController::class, 'detalhesPdf'])->name('dashboard3.detalhesPdf');

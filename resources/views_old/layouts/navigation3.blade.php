<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700"> 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden sm:flex space-x-8">
                ...
                <!-- Dropdown Menu Relatórios -->
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                            {{ __('Relatórios') }}
                            <svg class="ms-2 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="-mr-2 flex sm:hidden">
                <button @click="open = !open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden bg-white dark:bg-gray-800">
        ...
        <!-- Dropdown Menu Relatórios no Mobile -->
        <div class="border-t border-gray-200 dark:border-gray-700">
            <button @click="openReports = !openReports" class="w-full text-left px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                {{ __('Relatórios') }}
            </button>
            <div x-show="openReports" class="pl-4">
                ...
                <x-responsive-nav-link :href="route('reports.rl03')">
                    {{ __('Cirurgias por Mês') }}
                </x-responsive-nav-link>
            </div>
        </div>

    ...
    <div class="container mx-auto p-6 bg-gray-900 text-gray-200 dark:text-gray-800">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center space-x-4">
                <h1 class="text-3xl text-white font-bold">Visão Geral</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-green-500 text-white p-4 rounded-lg shadow-md dark:bg-green-200 dark:text-gray-900 flex justify-between items-center cursor-pointer hover:bg-green-400 active:bg-green-600 active:scale-95 active:shadow-inner transition-all duration-150 ease-in-out"
                onclick="redirectToObstetricSurgeries()">
                <div>
        ...
        <script>
            ...
            // function redirectToMostPerformedSurgery() {
            //     const surgeonId = "{{ $selectedSurgeonId }}";
            //     const startDate = "{{ $startDate }}";
            //     const endDate = "{{ $endDate }}";
            //     const surgeryType = "{{ $cirurgiaMaisRealizada ? urlencode($cirurgiaMaisRealizada->descricao) : '' }}";

            //     if (surgeonId && surgeryType) {
            //         window.location.href =
            //             `/dashboard3?surgery_types=${surgeryType}&surgeon_id=${surgeonId}&start_date=${startDate}&end_date=${endDate}&filter=most_performed`;
            //     } else {
            //         alert("Por favor, selecione um cirurgião para aplicar o filtro.");
            //     }
            // }
            ...
            function redirectToObstetricSurgeries() {
                ...
                if (surgeonId) {
                    window.location.href =
                        `/dashboard3?surgeon_id=${surgeonId}&start_date=${startDate}&end_date=${endDate}&surgery_type=Obstetrica`;
                } else {
                    alert("Por favor, selecione um cirurgião para aplicar o filtro.");
                }
            }
